...
ASiegeCharacter::ASiegeCharacter()
{
...
void ASiegeCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("leftclickstart", IE_Pressed, this, &ASiegeCharacter::left_click_pressed);
	PlayerInputComponent->BindAction("leftclickend", IE_Released, this, &ASiegeCharacter::left_click_released);


	PlayerInputComponent->BindAction("rightclickstart", IE_Pressed, this, &ASiegeCharacter::right_click_pressed);
	PlayerInputComponent->BindAction("rightclickend", IE_Released, this, &ASiegeCharacter::right_click_released);
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ASiegeCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ASiegeCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ASiegeCharacter::OnResetVR);
}
	


void ASiegeCharacter::left_click_pressed()
{


}

void ASiegeCharacter::left_click_released()
{

}

void ASiegeCharacter::right_click_pressed()
{


}

void ASiegeCharacter::right_click_released()
{
...
void ASiegeCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void ASiegeCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ASiegeCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
